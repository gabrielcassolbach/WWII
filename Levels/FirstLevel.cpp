...
{
<<<<<<< HEAD
    pPlayer1 = new Player(0, 20.0, 40.0, 30.00, 40.0, 0.0, 0.0, 10, 2, 0.3);
    ...
    StaticEntityList.includeEntity(static_cast<Entity *>(new Trench(6, 900.00, 580.00, 50.0, 5.0))); // Trincheira 1
    StaticEntityList.includeEntity(static_cast<Entity *>(new Trench(6, 1000.00, 580.00, 50.0, 5.0)));  // Trincheira 2
    StaticEntityList.includeEntity(static_cast<Entity *>(new Trench(6, 800.00, 100.00, 50.0, 5.0)));  // Trincheira 3    

    StaticEntityList.includeEntity(static_cast<Entity *>(new Cannon(7, 450.00, 530.00, 30.0, 5.0, 0.0, 0.0))); // Canhão 1
    StaticEntityList.includeEntity(static_cast<Entity *>(new Cannon(7, 600.00, 430.00, 30.0, 5.0, 0.0, 0.0)));  // Canhão 2
    StaticEntityList.includeEntity(static_cast<Entity *>(new Cannon(7, 950.00, 230.00, 30.0, 5.0, 0.0, 0.0)));  // Canhão 3   
...
=======
    ...
    createBoxes();
    createSnipers();
>>>>>>> c30d0a552a88dd6343d164c130b439723c9cb4df
...
Collision_Manager* FirstLevel::getCollisionManager(){
    return (&CM);
}
