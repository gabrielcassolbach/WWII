...
namespace Menus
{
    ...
    PauseMenu::PauseMenu(Game *pg, Levels::FirstLevel *lvl)
    {
        setText();
        setBackground();
        pGame = pg;
    ...
    PauseMenu::PauseMenu(Game *pg, Levels::SecondLevel *lvl)
    {
        setText();
        setBackground();
        pGame = pg;
    ...
    /*METHODS*/
    void PauseMenu::drawThis(Managers::Graphic_Manager *pGM)
    {
